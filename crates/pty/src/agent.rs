...
pub struct AgentDescriptor {
    ...
    /// The keystrokes that REFUSE a prompt. Several manifests carry this and
    /// it was being dropped, which left "no" unanswerable while "yes" worked —
    /// the worse half to lose, since a wrong approval is the expensive one.
    #[serde(default)]
    pub deny: Option<ApproveSpec>,
}
